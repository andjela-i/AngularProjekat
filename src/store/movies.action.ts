...
export const loadReviewsSuccess = createAction("Load reviews success", props<{reviews:MovieReview[]}>());
export const addReview = createAction("Add a review",props<{user:User,movie:Movie,review:string}>());
export const addReviewSuccess = createAction("Add review success",props<{review:MovieReview}>());
export const reviewUpdate = createAction("Review update", props<{user:User,movie:Movie,review:MovieReview}>());
export const reviewUpdateSuccess = createAction("Review update success", props<{review:MovieReview,user:User}>());
export const loadReviewsUser = createAction("Load reviews user",props<{user:User}>());
export const loadReviewsUserSuccess = createAction("Load reviews user success",props<{reviews:MovieReview[]}>());
...
export const deleteReview = createAction("delete a review",props<{review:MovieReview}>());
export const deleteReviewSuccess = createAction("delete review success",props<{review:MovieReview}>());
export const updateUsersReviews = createAction("upadate users reviews",props<{user:User,review:MovieReview}>());
